...
class GetWebPosPaymentsAction(ChainsideAuthenticatedAction):
    ...
    query_parameters_schema = {'status': {'type': 'string', 'rules': [
        'in:pending,partial,mempool_unconfirmed,unconfirmed,paid,cancelled,expired,network_dispute,mempool_network_dispute,possible_chargeback,chargeback'], 'description': 'Status of the payment orders to retrieve'}}
